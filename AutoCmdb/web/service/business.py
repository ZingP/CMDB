...
class Business(BaseServiceList):
    def __init__(self):
        # 查询条件的配置
        condition_config = [
            # {'name': 'cabinet_num', 'text': '业务线', 'condition_type': 'input'},
        ...
        table_config = [
            ...
            {
                'q': 'contact__users__name',
                'title': "业务联系人",
                'display': 1,
                'text': {'content': "{n}", 'kwargs': {'n': '@contact__users__name'}},
                'attr': {}
            },
            {
                'q': 'manager__users__name',
                'title': "系统管理员",
                'display': 1,
                'text': {'content': "{n}", 'kwargs': {'n': '@manager__users__name'}},
                'attr': {}
            },
...

            {
                ...
                'display': 1,
                'text': {
                    'content': "<a href='/xxx-{device_type_id}-{nid}.html'>查看详细</a> | <a href='/edit-xxx-{device_type_id}-{nid}.html'>编辑</a>",
    ...
    #
    # @staticmethod
    # def businesses_condition(request):
    ...
    def fetch_businesses(self, request):
    ...
    @staticmethod
    def businesses_detail(device_type_id, asset_id):
